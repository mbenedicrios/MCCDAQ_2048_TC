...
def run_example():
    ...
    try:
        ...
        value_counts = ul.a_in_32(board_num, channel, ULRange.BIP10VOLTS, options)

        # Convert from counts to volts
        value_volts = ul.to_eng_units_32(board_num, ULRange.BIP10VOLTS, value_counts)
        print("Channel{:d}: {:d} counts,  {:.3f} volts DC".format(channel, value_counts, value_volts))
